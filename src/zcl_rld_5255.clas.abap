...
CLASS zcl_rld_5255 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
*    out->write( 'test out run' ).
    DATA: lt_acc_categ TYPE STANDARD TABLE OF ztb_acc_cat_5255,
          lt_catego    TYPE STANDARD TABLE OF ztb_catego_5255,
          lt_libros    TYPE STANDARD TABLE OF ztb_libros_5255,
          lt_clientes  TYPE STANDARD TABLE OF ztb_client_5255,
          lt_clnts_lib TYPE STANDARD TABLE OF ztb_cln_lib_5255.
...
* data: lt_acc_categ type table of TABLA1,
*          lt_catego    type table of TABLA2,
*          lt_clientes  type table of TABLA3,
*          lt_clnts_lib type table of TABLA4,
*          lt_libros    type table of TABLA5.
...
******** TABLA1 ********
    ...
    DELETE FROM ztb_acc_cat_5255.
    INSERT ztb_acc_cat_5255 FROM TABLE @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_5255.
    INSERT ztb_catego_5255 FROM TABLE @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_client_5255.
    INSERT ztb_client_5255 FROM TABLE @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cln_lib_5255.
    INSERT ztb_cln_lib_5255 FROM TABLE @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_5255.
    INSERT ztb_libros_5255 FROM TABLE @lt_libros.
